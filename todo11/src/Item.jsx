...
export default class Item extends Component {
    ...
    render() {
        ...
        let { todo, delTodo, chengeHasCompleted, editTodo } = this.props
        let completed = todo.hasCompleted ? "completed" : ""
        let editing = inEdit ? completed + " editing" : completed
        return (
            <li className={editing}>
                <div className="view">
                    <input type="checkbox" className="toggle" checked={todo.hasCompleted} onChange={() => { chengeHasCompleted(todo) }} />
